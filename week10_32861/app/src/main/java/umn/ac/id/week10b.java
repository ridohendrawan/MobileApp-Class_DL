...
public class week10b extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Void>  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week10b);
    ...
    static class ContohLoader extends AsyncTaskLoader<Void> {
        static WeakReference<week10b> mActivity;
        int mCounter = 0;
        public ContohLoader(@NonNull Context context, int n, week10b main) {
            super(context);
            mCounter = n;
            mActivity = new WeakReference<week10b>(main);
        }
        @Nullable
        @Override
